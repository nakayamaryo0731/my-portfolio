---
title: "University of Londonの英語要件を突破してから入学するまで"
...
前回は[University of Londonに合格するために準備したこと <英語編2>](https://rons-blog.com/posts/uol-3/)で無事英語の入学要件を突破したことを書きました。
...
申請は[BSc Computer Science](https://www.london.ac.uk/study/courses/undergraduate/bsc-computer-science)ページ下部にある「Register your interest」から行いました。
...
University of LondonではStandard EntryとPerformance Basedの2つの選考方法があります。Standard Entryは学校の成績で選考されますが、Performance Basedは職歴や経験などで選考されます。
...
[REPL](https://world-class.github.io/REPL/)という学生有志で管理している情報共有サイトがあり、公式の情報より実践的な情報が載っているので眺めたりしてました。
